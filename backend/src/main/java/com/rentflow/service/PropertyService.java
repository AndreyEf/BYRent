...
public class PropertyService {
    ...
    public List<Property> getRentedProperties(UUID tenantId) {
        return propertyRepository.findByCurrentTenantId(tenantId);
    }

    public List<Property> getAvailableProperties(UUID userId) {
    ...
    @Transactional
    public Property createProperty(UUID ownerId, PropertyRequest request) {
    ...
    @Transactional
    public Property updateProperty(Long propertyId, UUID ownerId, PropertyRequest request) {
    ...
    @Transactional
    public void deleteProperty(Long propertyId, UUID ownerId) {
        Property property = propertyRepository.findById(propertyId)
            .orElseThrow(() -> new RuntimeException("Объект не найден"));
    ...
    @Transactional
    public Property removeTenant(Long propertyId, UUID ownerId) {
        Property property = propertyRepository.findById(propertyId)
            .orElseThrow(() -> new RuntimeException("Объект не найден"));
    ...
    private void closeTenantHistory(Long propertyId) {
    ...
    @Transactional
    public Property updateVisibility(Long propertyId, UUID ownerId, boolean isVisible) {
        Property property = propertyRepository.findById(propertyId)
            .orElseThrow(() -> new RuntimeException("Объект не найден"));
    ...
    @Transactional
    public Property updateActiveStatus(Long propertyId, UUID ownerId, boolean isActive) {
        Property property = propertyRepository.findById(propertyId)
            .orElseThrow(() -> new RuntimeException("Объект не найден"));
    ...
    public long countActiveProperties(UUID ownerId) {
        return propertyRepository.countActiveByOwnerId(ownerId);
    }

    @Transactional
    public Property leaveRental(Long propertyId, UUID tenantId) {
        Property property = propertyRepository.findById(propertyId)
            .orElseThrow(() -> new RuntimeException("Объект не найден"));
